...
const MainLayout = () => {
  ...
  const allNavLinks = [
    ...
    { path: '/trips', label: 'Trips', icon: <Route size={18} strokeWidth={1.5} />, roles: ['Dispatcher', 'Safety Officer', 'Driver'] },
    { path: '/maintenance', label: 'Maintenance', icon: <Wrench size={18} strokeWidth={1.5} />, roles: ['Fleet Manager', 'Financial Analyst'] },
    { path: '/fuel-logs', label: 'Fuel Logs', icon: <Droplet size={18} strokeWidth={1.5} />, roles: ['Financial Analyst', 'Driver'] },
